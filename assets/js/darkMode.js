function setLight () {
    document.getElementById('current-weather-items','place-container','current-temp','today','tomorrow','dayafter','day3','day4','day5').style.backgroundColor = "rgba(255, 255, 255, 0.6)"
    document.getElementById('current-weather-items','place-container','current-temp','today','tomorrow','dayafter','day3','day4','day5').style.color = "black"
