function setLight () {
    ...
    document.getElementById('dayafter').style.backgroundColor = "rgba(255, 255, 255, 0.8)"
    document.getElementById('dayafter').style.color = "black"
    document.getElementById('day3').style.backgroundColor = "rgba(255, 255, 255, 0.8)"
    document.getElementById('day3').style.color = "black"
    document.getElementById('day4').style.backgroundColor = "rgba(255, 255, 255, 0.8)"
